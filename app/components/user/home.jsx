      ...
      <div className="hidden lg:flex w-20 flex-col items-center py-6 bg-slate-900/50 backdrop-blur-xl border-r border-slate-700/50">
        ...
        <div className="flex flex-col gap-3 flex-1">
          <button
            ...
            className={`p-3.5 rounded-2xl transition-all transform hover:scale-105 ${
              !showFindUsers
...
<button
  ...
  className={`px-3 py-1.5 text-xs rounded-lg transition-all shadow ${
    user.isFollowing
          ...
          {notifications.length === 0 ? (
            ...
            notifications.map((notif, idx) => (
              <motion.div
                ...
                className={`p-4 rounded-xl mb-2.5 transition-colors ${
                  notif.read
