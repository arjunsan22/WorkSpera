    ...
    <div className="flex h-screen bg-[#020617] text-slate-200 overflow-hidden font-sans selection:bg-indigo-500/30">
      ...
      <aside className="hidden lg:flex w-[80px] flex-col items-center py-8 bg-slate-950 border-r border-slate-900 z-50">
        ...
        <div className="flex flex-col gap-6 mt-auto">
          ...
          <button onClick={() => router.push('/profile')} className="p-0.5 rounded-xl border border-indigo-500 transition-colors bg-indigo-500/10">
      ...
      >
        ...
        <div className="flex flex-col gap-6">
          ...
          <button onClick={() => { router.push('/profile'); setSidebarOpen(false); }} className="p-0.5 rounded-xl border border-indigo-500 bg-indigo-500/10">
            ...
            <div className="relative flex flex-col md:flex-row gap-6 md:gap-12 w-full">
              ...
              <div className="flex flex-row items-center justify-between gap-6 w-full md:hidden">
                <motion.div whileHover={{ scale: 1.02 }} className="relative flex-shrink-0">
                  ...
                  <button onClick={openEditProfileModal} className="absolute bottom-0 right-0 bg-indigo-600 text-white rounded-full p-1.5 shadow-xl border-2 border-slate-900 active:scale-95">
                ...
                <div className="flex-1 flex items-center justify-around">
                  ...
                  <button onClick={() => { fetchFollowers(); setShowFollowersModal(true); }} className="flex flex-col items-center">
                  ...
                  <button onClick={() => { fetchFollowing(); setShowFollowingModal(true); }} className="flex flex-col items-center">
              ...
              <motion.div whileHover={{ scale: 1.02 }} className="hidden md:block relative flex-shrink-0">
                ...
                <button onClick={openEditProfileModal} className="absolute bottom-2 right-2 bg-indigo-600 text-white rounded-full p-2.5 shadow-xl border-2 border-slate-900 active:scale-95">
              ...
              <div className="flex-1 flex flex-col items-start w-full">
                ...
                <div className="hidden md:flex flex-row items-center gap-4 mb-6">
                  ...
                  <button onClick={openEditProfileModal} className="px-5 py-1.5 bg-slate-100 hover:bg-white text-slate-900 text-sm font-semibold rounded-lg transition-all active:scale-95">
                    Edit Profile
                  </button>
                </div>
                ...
                <div className="hidden md:flex items-center gap-10 mb-6">
                  ...
                  <button onClick={() => { fetchFollowers(); setShowFollowersModal(true); }} className="flex items-center gap-2 group">
                    <span className="text-xl font-bold text-white group-hover:text-indigo-400 transition-colors">{user.followers?.length || 0}</span>
                    <span className="text-slate-400 text-base">followers</span>
                  </button>
                  <button onClick={() => { fetchFollowing(); setShowFollowingModal(true); }} className="flex items-center gap-2 group">
                    <span className="text-xl font-bold text-white group-hover:text-indigo-400 transition-colors">{user.following?.length || 0}</span>
                ...
                <div className="text-left mb-4 md:mb-8 w-full">
                  ...
                  <p className="text-slate-300 text-sm leading-relaxed whitespace-pre-wrap">{user.bio || 'Digital creator & professional'}</p>
                </div>

                {/* Mobile Action Buttons */}
                <div className="flex md:hidden flex-row items-center gap-2 w-full mt-2">
                   <button onClick={openEditProfileModal} className="flex-1 px-4 py-1.5 bg-slate-100 hover:bg-white text-slate-900 text-sm font-semibold rounded-lg transition-all active:scale-95 text-center">
                     Edit Profile
                   </button>
                   <button onClick={openEditPostsModal} className="p-2 bg-slate-800 hover:bg-slate-700 text-white border border-slate-700 rounded-lg transition-all active:scale-95 flex items-center justify-center">
                     <FiGrid className="w-5 h-5" />
                   </button>
                   <button onClick={() => setShowStoryUploader(true)} className="p-2 bg-slate-800 hover:bg-slate-700 text-white border border-slate-700 rounded-lg transition-all active:scale-95 flex items-center justify-center">
                     <FiPlus className="w-5 h-5" />
                   </button>
                   <button onClick={() => setShowStoryManager(true)} className="p-2 bg-slate-800 hover:bg-slate-700 text-white border border-slate-700 rounded-lg transition-all active:scale-95 flex items-center justify-center">
                     <FiImage className="w-5 h-5" />
                   </button>
                </div>

                {/* Desktop Action Buttons */}
                <div className="hidden md:flex flex-row items-center justify-start gap-3 w-full">
                  <button onClick={openEditPostsModal} className="px-6 py-2.5 bg-indigo-600 hover:bg-indigo-500 text-white rounded-xl transition-all font-medium flex items-center justify-center gap-2 shadow-lg shadow-indigo-500/10 active:scale-95">
                    <FiPlus className="w-5 h-5" /> Manage Posts
                  </button>
                  <button onClick={() => setShowStoryUploader(true)} className="px-6 py-2.5 bg-gradient-to-r from-pink-600 to-rose-500 hover:opacity-90 text-white rounded-xl transition-all font-medium flex items-center justify-center gap-2 shadow-lg shadow-rose-500/10 active:scale-95">
                    <FiPlus className="w-5 h-5" /> Add Story
                  </button>
                  <button onClick={() => setShowStoryManager(true)} className="px-6 py-2.5 bg-slate-800/50 hover:bg-slate-800 text-white rounded-xl transition-all font-medium border border-slate-700 flex items-center justify-center gap-2 active:scale-95">
                    Stories
                  </button>
                </div>
