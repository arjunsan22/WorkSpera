...
export default function RegisterPage() {
  ...
  return (
    <div ref={containerRef} className="flex min-h-screen bg-[#020617] text-slate-200 overflow-hidden font-sans selection:bg-indigo-500/30 relative">
      <style jsx global>{`
      ...
      <div className="z-10 w-full flex items-center justify-center p-4 py-12 overflow-y-auto custom-scrollbar">
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {/* Password */}
            <div ref={addToRefs} className="group space-y-1.5">
              <label className="text-[10px] font-bold uppercase tracking-[0.2em] text-slate-500 ml-1">Security Key</label>
              <div className="relative">
                <div className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-500 group-focus-within:text-indigo-400 transition-colors">
